...
//        HttpResponse response = sendData(data);
    ...
    public static String makeRegistrationQuery(String email, String deviceId, String passkey){
        JSONObject data = MakeJson.wrapRegistration(email, deviceId, passkey);
        Log.d("JsonObject", String.valueOf(data));
        //new SendJson(url, data, new Response.Listener<JSONObject>(){});
//        SendJson.sendData(data);
//        HttpResponse response = sendData(data);
        String response = SendData3(data);
        return response;

    }

    public static String SendData3(JSONObject data) {
